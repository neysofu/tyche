...
trait Sampling {
   ...
   *
   * See
   *  http://sphweb.bumc.bu.edu/otlt/MPH-Modules/BS/BS704_Power/BS704_Power3.html
   * for sample size determination when dealing with continuous random
   * variables.
   *
   * The default value assures a confidence level of 95% and a margin of
   * error of 0.01 for distributions with a normal (<=0.5) standard
   * deviation.
   */
